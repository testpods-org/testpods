...
**Agent:** step-04-reviewer | **Completed:** {timestamp}
...
The previous agent (step-04-validation-fixer) completed their work.
Their report is at: `/Users/henrik/git/henrik/testpods_project/testpods/flows/create-container-spec-builder/step-4/agents/step-04-validation-fixer/report.complete.md`
...
Write regular progress updates to: `/Users/henrik/git/henrik/testpods_project/testpods/flows/create-container-spec-builder/step-4/agents/step-04-reviewer/report.md`
...
- Write your completed report to: `/Users/henrik/git/henrik/testpods_project/testpods/flows/create-container-spec-builder/step-4/agents/step-04-reviewer/report.md`
...
- [✅] Step 2: Create ContainerSpec Fluent Builder
- [✅] Step 3: Add Unit Tests for ContainerSpec and ProbeSpec
- [❌] Step 4: Update GenericTestPod to Use ContainerSpec <-- YOU ARE HERE

### Current Step (Full Content)

### Status: ❌ | Step 4: Update GenericTestPod to Use ContainerSpec

#### Step 4 Purpose

Demonstrate the new API in practice by updating an existing pod type. This validates the API design works for real use cases and provides a migration example.

#### Step 4 Description

Update `GenericTestPod.java` in `core/src/main/java/org/testpods/core/pods/`:

1. Find the `buildMainContainer()` method (or equivalent container-building code)
2. Replace raw `ContainerBuilder` usage with `ContainerSpec`
...
new ContainerBuilder()
    .withName(...)
    .withImage(...)
    .addNewPort().withContainerPort(...).endPort()
...
**Acceptance criteria:**
- All existing GenericTestPod tests still pass
- Code is shorter and more readable
- No behavioral changes to GenericTestPod
...
- [ ] Javadoc includes usage examples
