...
[Summarize the work you did as a concise bullet point list. Each bullet should describe a concrete accomplishment. Focus on what was actually done, not just what was planned. Examples:

- Completed the assigned analysis task
- Processed input data and generated output
- Identified key findings and documented results
- Resolved blockers encountered during execution]
...
[List the files you created or modified during this step.

Example format:

- output/results.json (analysis results, 50 lines)
- logs/execution.log (appended execution log entry)
...
- Fill in the report template above with:
  ...
  - Any notes or important decisions
...
- An agent who completes their assigned work signals Success
- An agent who reviews something and reports findings signals Success (the review was successful!)
