...
class EmptyDirStorageManagerTest {
    ...
    void getVolumes_withAllOptions_setsAll() {
        EmptyDirStorageManager manager = new EmptyDirStorageManager("/cache")
    ...
    void getMountsFor_returnsSingleMount() {
        EmptyDirStorageManager manager = new EmptyDirStorageManager("/var/cache")
            .withVolumeName("cache");
