...
class SecretStorageManagerTest {
  ...
  void readOnly_setsReadOnly() {
    SecretStorageManager manager = new SecretStorageManager("secret", "/secrets").readOnly(false);
  ...
  void getVolumes_withDefaultMode_setsMode() {
    SecretStorageManager manager =
        new SecretStorageManager("secret", "/secrets").withDefaultMode(0400);
