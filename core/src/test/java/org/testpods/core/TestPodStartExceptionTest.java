...
class TestPodStartExceptionTest {
    ...
    void shouldCreateWithPodNameMessageAndCause() {
        ...
        TestPodStartException exception = new TestPodStartException(
            "my-pod", "connection refused", cause);
    ...
    void shouldCreateWithMessageAndCause() {
        ...
        TestPodStartException exception = new TestPodStartException(
            "Failed to start pod 'test-pod': timeout", cause);
    ...
    void shouldExtractPodNameFromMessage() {
        TestPodStartException exception = new TestPodStartException(
            "Failed to start pod 'postgres-test': network error", null);
    ...
    void shouldReturnUnknownWhenPodNameCannotBeExtracted() {
        TestPodStartException exception = new TestPodStartException(
            "Some random error message", null);
