...
class WorkloadConfigTest {
  ...
  void shouldCreateWithBuilder() {
    ...
    try {
      Container container =
          new ContainerBuilder().withName("main").withImage("nginx:latest").build();

      PodSpec podSpec = new PodSpecBuilder().addToContainers(container).build();
  ...
  void shouldReturnSelector() {
    ...
    try {
      ...
      WorkloadConfig config =
          new WorkloadConfig("my-app", "my-ns", Map.of("app", "my-app"), null, podSpec, client);
    ...
    try {
      ...
      assertThatThrownBy(
              () ->
                  new WorkloadConfig(
                      null, // null name
                      "my-ns", Map.of(), Map.of(), podSpec, client))
  ...
  void shouldRejectNullNamespace() {
    ...
    try {
      ...
      assertThatThrownBy(
              () ->
                  new WorkloadConfig(
                      "my-pod", null, // null namespace
                      Map.of(), Map.of(), podSpec, client))
          .isInstanceOf(NullPointerException.class)
  ...
  void shouldRejectNullPodSpec() {
    ...
    try {
      assertThatThrownBy(
              () ->
                  new WorkloadConfig(
                      "my-pod", "my-ns", Map.of(), Map.of(), null, // null podSpec
                      client))
          .isInstanceOf(NullPointerException.class)
  ...
  void shouldRejectNullClient() {
    ...
    assertThatThrownBy(
            () ->
                new WorkloadConfig(
                    "my-pod", "my-ns", Map.of(), Map.of(), podSpec, null // null client
                    ))
        .isInstanceOf(NullPointerException.class)
  ...
  void labelsShouldBeImmutable() {
    ...
    try {
      ...
      WorkloadConfig config =
          new WorkloadConfig("my-pod", "my-ns", Map.of("app", "my-pod"), Map.of(), podSpec, client);
