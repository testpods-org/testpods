 ...
 * <p>
 * This is the most Kubernetes-native wait strategy. It trusts the pod's
 * configured readiness probe and polls the K8s API until the pod's
 * {@link TestPod#isReady()} returns true.
 * <p>
 * The readiness probe is configured on the pod's container spec and can be:
 * <ul>
 *   <li>HTTP GET - checks a specific endpoint</li>
 *   <li>TCP Socket - checks if a port is open</li>
 *   <li>Exec - runs a command in the container</li>
 * </ul>
 * <p>
 * Example usage:
 * <pre>{@code
...
public class ReadinessProbeWaitStrategy implements WaitStrategy {
    ...
    public String toString() {
        return String.format("ReadinessProbeWaitStrategy[timeout=%s, pollInterval=%s]",
