 ...
 *
 * <ul>
 *   <li>Database health checks (e.g., mysqladmin ping)
 *   <li>Checking for file existence (e.g., test -f /tmp/ready)
 *   <li>Custom readiness scripts
 *   <li>Service-specific health commands
 * </ul>
 *
 * <p>Example usage:
 *
...
public class CommandWaitStrategy implements WaitStrategy {
  ...
  public String toString() {
    return String.format(
        "CommandWaitStrategy[command='%s', timeout=%s]",
