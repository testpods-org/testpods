 ...
 *
 * <p>This record captures all the information needed to create a workload resource (Deployment,
 * StatefulSet, etc.) in the cluster.
 *
...
public record WorkloadConfig(
  ...
  /** Get the selector labels for matching pods. Uses the "app" label from the labels map. */
