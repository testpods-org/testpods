 ...
 *
 * <p>This is an internal implementation detail, not exposed to pod users. It extracts the workload
 * management logic from the pod class hierarchy to enable composition over inheritance.
 *
 * <p>Each implementation handles a specific workload type:
 *
 * <ul>
 *   <li>{@link DeploymentManager} - for stateless pods
 *   <li>{@link StatefulSetManager} - for stateful pods requiring stable identity
 * </ul>
 */
