 ...
 *
 * <p>Headless services don't get a cluster IP. Instead, DNS returns the pod IPs directly. This is
 * required for StatefulSets to provide stable network identities.
 *
 * <p>This is appropriate for:
 *
 * <ul>
 *   <li>StatefulSet stable DNS (pod-0.service-name.namespace.svc.cluster.local)
 *   <li>Client-side load balancing
 *   <li>Service discovery without kube-proxy
 * </ul>
 */
