 ...
 * <p>
 * ClusterIP is the default service type for Kubernetes. It exposes the service
 * on a cluster-internal IP, making it only reachable from within the cluster.
 * <p>
 * This is appropriate for:
 * <ul>
 *   <li>Internal services accessed by other pods</li>
 *   <li>Default service type for Deployment-based pods</li>
 *   <li>Services that don't need external access</li>
 * </ul>
 */
