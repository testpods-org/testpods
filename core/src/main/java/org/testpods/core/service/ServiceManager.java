 ...
 *
 * <p>This is an internal implementation detail, not exposed to pod users. It extracts service
 * management logic from the pod class hierarchy to enable composition over inheritance.
 *
 * <p>Available implementations:
 *
 * <ul>
 *   <li>{@link ClusterIPServiceManager} - Default for Deployments
 *   <li>{@link HeadlessServiceManager} - For StatefulSet stable DNS
 *   <li>{@link NodePortServiceManager} - For external access
 *   <li>{@link CompositeServiceManager} - Combines multiple service types
 * </ul>
 */
