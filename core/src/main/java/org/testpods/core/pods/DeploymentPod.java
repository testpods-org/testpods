 ...
 * <p>
 * Deployments are appropriate for:
 * <ul>
 *   <li>Stateless application services</li>
 *   <li>Generic containers without specific persistence needs</li>
 *   <li>Services that don't need stable network identity</li>
 * </ul>
 * <p>
 * This class handles:
 * <ul>
 *   <li>Deployment creation and lifecycle</li>
 *   <li>ClusterIP Service creation</li>
