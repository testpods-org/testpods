 ...
 *
 * <p>This is an internal implementation detail, not exposed to pod users directly. It provides
 * volumes, volume mounts, and PVC templates for workloads.
 *
 * <p>Available implementations:
 *
 * <ul>
 *   <li>{@link NoOpStorageManager} - No storage (default)
 *   <li>{@link PersistentStorageManager} - PVC-backed storage
 *   <li>{@link EmptyDirStorageManager} - Ephemeral scratch space
 *   <li>{@link ConfigMapStorageManager} - ConfigMap volume mounting
 *   <li>{@link SecretStorageManager} - Secret volume mounting
 *   <li>{@link CompositeStorageManager} - Combines multiple storage types
 * </ul>
 */
public interface StorageManager {
   ...
   *
   * <p>Returns empty list for workloads that don't support volume claim templates or for storage
   * types that don't use PVCs.
   *
   ...
   *
   * <p>StatefulSets use volumeClaimTemplates instead, so this is a no-op for them.
   *
